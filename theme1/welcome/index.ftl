...
<html>
<head>
    <title>Welcome to MBIX SSO</title>

    <meta charset="utf-8">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="robots" content="noindex, nofollow">

    <link rel="shortcut icon" href="${resourcesPath}/mbix-logo.jpg">
  ...
  <div class="row">
    <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
      <div class="welcome-header">
        <img src="${resourcesPath}/mbix-logo-text.png" alt="${productName}" border="0" />
        <h1>Welcome to <strong>MBIX SSO</strong></h1>
      </div>
      <div class="row">
